...
let reg1 = /love/gi
console.log(sentence1.match(reg1))

// Use match() to count the number of all because in the following sentence:'You cannot end a sentence with because because because is a conjunction'
let sentence2 = 'You cannot end a sentence with because because because is a conjunction'
let reg2 = /because/gi
console.log(sentence2.match(reg2))
...
let regex = /\d+/g
let numbers = salaryStatement.match(regex)
let salary = Number(numbers[0])*12 + Number(numbers[1]) + Number(numbers[2])*12
console.log(salary)
